...
<body>
    ...
    <body>
        ...
        <div id="watermark">
            <img src="assets/img/misana.png" alt="logo" height="70" width="100" style="float:right;padding-right:62px;margin-top:-25px;">
            <!-- <img src="assets/img/misana.ico" height="100%"  style="opacity: 0.05;"/> -->
        </div>
        <section>
            <div class="box" style="margin-top:80px;">
                ...
                <center>
                    <h3 style="margin-left:30px;margin-top:-10px;"><strong style="color:green">Material Report <br> Stock-<?php echo $status ?><p style="color:red">From</p><?php echo $from; ?><p style="color:red">To</p><?php echo $to; ?></strong></h3>
                </center>
