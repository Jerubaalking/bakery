...
<div class="section__content section__content--p30">
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top:80px;">
            <center>
                <h3 style="margin-left:30px;margin-top:-10px;"><strong style="color:green">Stock Report</strong></h3>
            </center>
            <center>
                <h3 style="margin-left:30px;margin-top:-10px; font-size:10px;"><strong style=""><?php echo $kevi = date('Y-m-d H:m:s'); ?></strong></h3>
            </center>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Total:</td>
                                    <td>
                                        <strong style="color:#4682B4">{{$sum_stock}}</strong>
                                    </td>
