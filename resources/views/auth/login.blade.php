...
<head>
    <title>Login | misana Home Bakery</title>
    <meta charset="utf-8">
            ...
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            <div class="header">
                                <div class="logo text-center"><img src="{{asset('assets/img/misana.png')}}"  width="220" height="240"></div>
                            ...
                            <form class="form-auth-small" method="POST" action="{{ route('login') }}">
                                ...
                                <button type="submit" class="btn btn btn-lg btn-block" style="background:rgba(255, 99, 71, 0.6);color:white;">LOGIN</button>
                                <div class="bottom">
                    ...
                    <div class="right" >
                        ...
                        <div class="content text">
                           <center> <h1 class="heading"><strong>Misana Home Bakery </strong></h1></center>
