...
<div class="section__content section__content--p30">
    <div class="container-fluid">
        <div id="watermark">
            <img src="assets/img/misana.png" alt="logo" height="70" width="120" style="float:right;padding-right:62px;margin-top:-25px;">
        </div>

        <div> <span style="font-family:sans-serif; font-size:10px;">
                <?php
