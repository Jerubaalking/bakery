    ...
    <div class="section__content section__content--p30 page">
        <div class="container-fluid">
            <small class="top_tag"><?php 
            date_default_timezone_set("Africa/Nairobi");
            echo '>>> '.date("D d, M Y").' '.date("h:i:sa").' <<<'
            ?></small>
            <!-- <div id="watermark">
                            <img src="/assets/img/misana.png" alt="logo" height="100" width="150"
                                style="float:right;padding-right:62px;margin-top:-25px;">
                        </div>  -->
