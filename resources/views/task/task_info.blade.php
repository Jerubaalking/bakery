                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <ul class="list-unstyled">
                                <li>Task Number:<b> {{$data[0]->task_number}}</b> </li>
                            ...
                            <div class="pull-left">
                                <div class="input-group-btn">
                                    <button type="button" class="btn btn-info dropdown-toggle margin"
                                        data-toggle="dropdown">View Report
                    ...
                    <div class="box-body">
                        <div class="table-responsive table-striped  table-responsive">
                            <table class="table  table-striped table-data2">
                                <thead>
                                    <h3 class="title-5 m-b-35">Latest Tasks</h3>
                                    <tr>
                                        <th>Salers Name</th>
                                        <th>Saler Number</th>
                                        <th>Task Number</th>
                                ...
                                <tbody>
                                    ...
                                    <td>{{ $i->created_at}}</td>
                                    <td>
                                        <a href="/task_info/{{$i->id}}" class="btn btn-sm btn-info"><i
